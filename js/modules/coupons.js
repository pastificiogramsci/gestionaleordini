...
const CouponsModule = {
    ...
    createCampaign(campaignData) {
        const campaign = {
            ...
            dateType: campaignData.dateType,
            dates: campaignData.dates || [],
            dateFrom: campaignData.dateFrom || null,
            dateTo: campaignData.dateTo || null,
        ...
        Utils.showToast("✅ Campagna creata!", "success");
        return campaign;
    },
    ...
    assignCoupon(customerId, campaignId) {
        const customer = CustomersModule.getCustomerById(customerId);
        const campaign = this.getCampaignById(campaignId);

        if (!customer || !campaign) return null;
